 ...
 */
class ReplaceDeployCommandHook extends BltTasks {
   ...
   *
   * @hook replace-command deploy:build
   */
   ...
   *
   * @hook replace-command deploy:update
   */
   ...
   *
   * @hook replace-command deploy:drupal:install
   */
