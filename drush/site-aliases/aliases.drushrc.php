...
// Site acsfdev, environment dev
$aliases['dev'] = array(
  'root' => '/var/www/html/acsfdev.dev/docroot',
  'ac-site' => 'acsfdev',
  'ac-env' => 'dev',
  'ac-realm' => 'prod',
  'uri' => 'acsfdevdev.prod.acquia-sites.com',
  'remote-host' => 'staging-13081.prod.hosting.acquia.com',
  'remote-user' => 'acsfdev.dev',
  'path-aliases' => array(
...
$aliases['dev.livedev'] = array(
  'parent' => '@acsfdev.dev',
  'root' => '/mnt/gfs/acsfdev.dev/livedev/docroot',
);
...
// Site acsfdev, environment prod
$aliases['prod'] = array(
  'root' => '/var/www/html/acsfdev.prod/docroot',
  'ac-site' => 'acsfdev',
  'ac-env' => 'prod',
  'ac-realm' => 'prod',
  'uri' => 'acsfdev.prod.acquia-sites.com',
  'remote-host' => 'web-12383.prod.hosting.acquia.com',
  'remote-user' => 'acsfdev.prod',
  'path-aliases' => array(
    '%drush-script' => 'drush' . $drush_major_version,
  )
);
$aliases['prod.livedev'] = array(
  'parent' => '@acsfdev.prod',
  'root' => '/mnt/gfs/acsfdev.prod/livedev/docroot',
);
...
// Site acsfdev, environment ra
$aliases['ra'] = array(
  'root' => '/var/www/html/acsfdev.ra/docroot',
  'ac-site' => 'acsfdev',
  'ac-env' => 'ra',
  'ac-realm' => 'prod',
  'uri' => 'acsfdevra.prod.acquia-sites.com',
  'remote-host' => 'staging-15594.prod.hosting.acquia.com',
  'remote-user' => 'acsfdev.ra',
  'path-aliases' => array(
    '%drush-script' => 'drush' . $drush_major_version,
  )
);
$aliases['ra.livedev'] = array(
  'parent' => '@acsfdev.ra',
  'root' => '/mnt/gfs/acsfdev.ra/livedev/docroot',
);
...
// Site acsfdev, environment test
$aliases['test'] = array(
  'root' => '/var/www/html/acsfdev.test/docroot',
  'ac-site' => 'acsfdev',
  'ac-env' => 'test',
  'ac-realm' => 'prod',
  'uri' => 'acsfdevstg.prod.acquia-sites.com',
  'remote-host' => 'staging-13081.prod.hosting.acquia.com',
  'remote-user' => 'acsfdev.test',
  'path-aliases' => array(
    '%drush-script' => 'drush' . $drush_major_version,
  )
);
$aliases['test.livedev'] = array(
  'parent' => '@acsfdev.test',
  'root' => '/mnt/gfs/acsfdev.test/livedev/docroot',
);
